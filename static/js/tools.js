  ...
  TOOL_RENDERERS['portfolio-builder'] = function (el) {
    ...
    function generatePortfolio() {
      ...
      function buildClientSidePortfolioHtml(username, state) {
        ...
        html += '<nav class="navbar"><a href="#" class="nav-brand"><i class="fas fa-layer-group"></i> <span>'+name.split(' ')[0]+'</span></a><a href="#contact" class="nav-btn">Get in Touch <i class="fas fa-arrow-right" style="margin-left:6px; font-size:0.8em;"></i></a></nav>';
        ...
        if (resumeUrl && /^https?:\/\//i.test(resumeUrl)) {
          html += '<a href="'+resumeUrl+'" target="_blank" class="btn-primary"><i class="fas fa-file-pdf"></i> View Resume</a>';
        }
        if (linkedin && /^https?:\/\//i.test(linkedin)) {
          html += '<a href="'+linkedin+'" target="_blank" class="btn-outline"><i class="fab fa-linkedin" style="color:#0A66C2;"></i> LinkedIn</a>';
        }
        if (github && /^https?:\/\//i.test(github)) {
          html += '<a href="'+github+'" target="_blank" class="btn-outline"><i class="fab fa-github"></i> GitHub</a>';
        }
        ...
        html += '<div class="card" style="padding: clamp(32px, 6vw, 48px);"><p class="card-body" style="font-size: 1.15rem;">'+summary+'</p></div>';
        html += '</div></section>';
        ...
        if (phone) {
          html += '<a href="tel:'+phone+'" class="btn-outline"><i class="fas fa-phone-alt"></i> Call Me</a>';
        }
        if (!email && !phone && linkedin) {
          html += '<a href="'+linkedin+'" target="_blank" class="btn-primary"><i class="fab fa-linkedin"></i> Connect on LinkedIn</a>';
        }
